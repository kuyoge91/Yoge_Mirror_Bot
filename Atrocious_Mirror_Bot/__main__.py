...
def start(update, context):
    ...
    buttons.buildbutton("Cloud Drive Group", "https://t.me/drivetalk")
    buttons.buildbutton("Bot Tutorials", "https://t.me/BotTutorialsMM")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Hi, I'm DriveTalk Mirror Bot, a multipurpose bot for [Anonymous_yz](t.me/Anonymous_yz)
I can mirror all your links to Google Drive!
Type /{BotCommands.HelpCommand} to get a list of available commands
For any question join [DriveTalk Bot Support](t.me/drivetalk)
'''
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='DriveTalk Mirror Help',
        author_name='Anonymous_yz',
        author_url='https://t.me/Anonymous_yz',
...
def main():
    ...
    if os.path.isfile(".restartmsg"):
        ...
        try:
            text = "<b>DriveTalk Mirror Bot Restarted!</b>"
    ...
    LOGGER.info("DriveTalk Mirror Bot Started!")
